...
class PlayerAgent:
    def __init__(self, board, transition_matrix, time_left_func):
        ...
        # Plum: more carpet/board-score focused
        self.weights = {
            "prime_exp": 2.2,
            "prime_mult": 0.75,
            "center_bonus": 0.45,
            "rat_confidence_threshold": 0.22,
        }
    ...
    def minimax(self, board, depth, alpha, beta, is_maximizing, start_time, time_limit):
        ...
        if is_maximizing:
            ...
            def move_priority(move):
                if move.move_type == MoveType.CARPET:
                    return 100 + getattr(move, "roll_length", 0)
            ...
            for move in valid_moves:
                ...
                eval_score, _ = self.minimax(
                    next_board, depth - 1, alpha, beta, False, start_time, time_limit
                )
        ...
        for move in valid_moves:
            ...
            eval_score, _ = self.minimax(
                next_board, depth - 1, alpha, beta, True, start_time, time_limit
            )
